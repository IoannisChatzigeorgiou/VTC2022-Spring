function sim_RLC_only_for_fig3(K, L, e_dest, e_diff)
% --------------------------------------------------------------------
...
% --------------------------------------------------------------------
% Syntax:
% > sim_RLC_only_for_fig3(K, L, e_dest, e_diff)
%
% --- Input arguments ---
...
% e_diff  : Define how much larger is e_eaves than e_dest
...
filename = ['data_RLC_K',num2str(K),'_',str_e_diff,'.mat'];
